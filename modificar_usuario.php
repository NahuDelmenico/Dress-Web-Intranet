    ...
    <?php require_once('layout/nav_intranet.php') ?>
        <div class="container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="rol" id="rol" class="form-control" placeholder="Ingrese el nuevo mail" value="<?php echo $datos->rol; ?>">
                        </div>
                ...
                <button href="lista_usuarios.php" type="submit" name="MODIFICACION" class="btn btn-primary" value="ok">Modificar usuario</button>
